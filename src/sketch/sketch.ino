...
public: 
  ...
  void set_pin( uint8_t pin_num, bool pin_state ) { //set state for pin
    ...
    if ( pin_state != old_pin_state ) {
      ...
      if ( pin_state )  //if new state is "1"
...
void setup() {
  ...
  prs_led.init_pin(L_25P, 0);
  prs_led.init_pin(L_50P, 1);
  prs_led.init_pin(L_100P, 2);
  prs_led.init_pin(L_150P, 3);
  prs_led.init_pin(L_200P, 4);
  prs_led.init_pin(L_50PM, 5);
  prs_led.init_pin(L_100PM, 6);
  prs_led.init_pin(L_150PM, 7);
  prs_led.init_pin(L_200PM, 8);
